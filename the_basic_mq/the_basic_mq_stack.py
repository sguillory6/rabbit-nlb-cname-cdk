...
class TheBasicMQStack(cdk.Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        cdk.CfnOutput(self, 'bastionToMQGroupSGID', value=bastion_to_mq_group.security_group_id)
        ...
        cdk.CfnOutput(self, 'bastionInstanceID', value=bastion.instance_id)

        cdk.CfnOutput(self, 'bastionPublicDNS', value=bastion.instance_public_dns_name)
